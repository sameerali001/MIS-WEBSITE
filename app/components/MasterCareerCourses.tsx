...
export default function MasterCareerCourses() {
    ...
    return (
        <section className="mt-16 w-full relative">
            ...
            <div className="rounded-[56px_0_0_0] lg:rounded-[560px_0_0_0] bg-slate-600 text-white p-6 sm:p-8 lg:p-10 w-full mt-10">
                <div className="grid gap-8 w-full grid-cols-1 lg:grid-cols-[280px_1fr_320px] items-start">
                    {/* Left Image Panel */}
                    <div className="w-full">
                        <div className="rounded-2xl overflow-hidden shadow-lg bg-white">
                            <img
                                src="https://images.unsplash.com/photo-1485827404703-89b55fcc595e?q=80&w=900&auto=format&fit=crop&ixlib=rb-4.1.0"
                                alt="Certification Courses"
                                className="w-full h-[360px] object-cover"
                            />
                        </div>
                        <h3 className="mt-4 text-3xl font-bold">Certification Courses</h3>
                        <div className="mt-2 h-0.5 w-32 bg-white/70" />
                    </div>
                    ...
                    <div className="grid gap-6 lg:grid-cols-2">
                        <div className="space-y-5 text-slate-100/90 leading-relaxed">
                            <p>
                                Get certified by leading cloud and technology platforms. Our certification
                                courses are designed to help you earn recognized credentials that employers value.
                            </p>
                            <p>
                                We provide comprehensive training aligned with official certification exam content.
                                Our instructors have hands-on experience with each platform and share their
                                professional expertise throughout the course.
                            </p>
                            <p>
                                Gain practical skills through labs and exercises using real cloud platforms.
                            </p>
                        </div>
                        ...
                        <div className="space-y-5 text-slate-100/90 leading-relaxed">
                            ...
                            <p>
                                Our exam preparation includes practice tests, detailed study materials,
                                and one-on-one guidance from certified professionals.
                            </p>
                            <p>
                                Boost your career prospects with industry-recognized certifications that
                                demonstrate your expertise to employers worldwide.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="px-5 pb-6">
                            ...
                            <div className="mt-3 space-y-2 text-sm text-slate-200">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span>{certificationCourses[0].duration}</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-white/10 text-white">
                                        <svg
                                    ...
                                    <span>{certificationCourses[0].mode}</span>
                                </div>
                            </div>
                            <div className="mt-4 border-t border-white/20" />
                            <div className="mt-3 text-sm font-semibold text-slate-100">
